...
const About = ({ content }) => {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      >
        <Avatar src={content.profile.aboutAvatarImage || content.profile.homeAvatarImage || "/avatar.png"} opacity={content.profile.aboutAvatarOpacity ?? 1} />
      </motion.div>
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        >
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
            {(content.aboutData?.length ? content.aboutData : aboutData).map((item, itemI) => (
              <div
                key={itemI}
                className={`${
                  index === itemI &&
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            {(content.aboutData?.length ? content.aboutData : aboutData)[index].info.map((item, itemI) => (
              <div
                key={itemI}
